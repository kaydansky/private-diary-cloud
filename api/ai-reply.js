...
export default async function handler(req, res) {
    ...
    try {
        ...
        promptAddition += starterUsername ? ` Можешь обратиться к автору этого промпта по имени ${starterUsername}, но необязательно.` : '';
        promptAddition += username === 'Алексей' ? ' Отвечай в шутливой манере.' : '';
        promptAddition += ' Если спросили, кто ты, откуда ты и тому подобное, то уклоняйся от ответа, можно в шутливой форме.';
