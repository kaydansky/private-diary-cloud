...
const translations = {
    en: {
        ...
        howItWorksPoint6: '',
        howItWorksPoint7: 'Without signing up, you can browse all entries, search content, and explore the calendar.',
        howItWorksPoint8: 'The app works on both mobile devices and desktop computers. To share the app, simply send the link https://snt-tishinka.ru to your friends and acquaintances.',
        howItWorksPoint9: 'The app is open source and can be found on GitHub: XXXXXXXXXXXXXXXXX',
        close: 'Close',
        poll: 'Poll',
        ...
        alertTooLongQuestion: 'Poll question must be 300 characters or less',
        ...
        entryContainsImages: 'This entry contains images'
    },
    fr: {
        ...
        howItWorksPoint6: '',
        howItWorksPoint7: 'Sans inscription, vous pouvez parcourir toutes les entrées, rechercher du contenu et explorer le calendrier.',
        howItWorksPoint8: 'L\'application fonctionne à la fois sur les appareils mobiles et les ordinateurs de bureau. Pour partager l\'application, envoyez simplement le lien https://snt-tishinka.ru à vos amis et connaissances.',
        ...
        alertTooLongQuestion: 'Sondage question must be 300 characters or less',
    ...
    de: {
        ...
        howItWorksPoint6: '',
        howItWorksPoint7: 'Ohne Anmeldung können Sie alle Einträge durchsuchen, Inhalte suchen und den Kalender erkunden.',
        howItWorksPoint8: 'Das Programm funktioniert sowohl auf mobilen Geräten als auch auf Desktop-Computern. Um das Programm zu teilen, senden Sie einfach den Link https://snt-tishinka.ru an Ihre Freunde und Bekannten.',
        howItWorksPoint9: 'Der Quellcode ist öffentlich und kann auf GitHub gefunden werden: XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX',
        close: 'Schließen',
        poll: 'Umfrage',
        pollQuestion: 'Frage',
        ...
        alertTooLongQuestion: 'Umfragefrage darf maximal 300 Zeichen lang sein',
    ...
    ru: {
        ...
        signInWord: 'Войдите',
        footerText: ', чтобы читать, оставлять записи и получать уведомления.',
        ...
        howItWorksPoint1: 'Чтобы зарегистрироваться, надо ввести своё имя пользователя и придумать пароль.',
        ...
        howItWorksPoint5: 'Нажмите "Запись", "Фото" или "Опрос", чтобы добавить соответствующий контент. Три точки возле записи — вызов меню: пересылайте записи и изображения куда угодно, редактируйте или удаляйте свой контент.',
        howItWorksPoint6: 'Чтобы ответить на конкретное сообщение, нажмите на него долгим нажатием (более 1 сек) либо воспользуйтесь меню (точки возле записи).',
        howItWorksPoint7: 'Можно изменить своё имя пользователя или удалить аккаунт без следов. Можно удалить все свои записи или фото одним нажатием. Для этого перейдите в \"Аккаунт\" в верхнем меню.',
        howItWorksPoint8: 'Без регистрации вы можете просматривать все записи, голосовать в опросах могут только зарегистрированные пользователи.',
        howItWorksPoint9: 'Приложение работает как на мобильном устройстве, так и на настольном компьютере. Чтобы поделиться приложением, просто отправьте ссылку https://snt-tishinka.ru. Для этого в верхнем меню есть опция "Поделиться приложением".',
        close: 'Закрыть',
        poll: 'Опрос',
        ...
        alertTooLongQuestion: 'Вопрос должен быть не длиннее 300 символов',
